# BÁCH KHOA TOÀN THƯ NGỮ CẢNH DỊCH THUẬT (MASTER CONTEXT BIBLE)
## Game: 魔法少女ノ魔女裁判 (Mahou Shoujo no Majo Saiban / Magical Girl Witch Trials)

Tài liệu này là **ngữ cảnh chuẩn mực bắt buộc (Ground Truth)** dành cho AI và dịch giả khi thực hiện bản địa hoá toàn bộ game sang Tiếng Việt. Mọi câu thoại, thuật ngữ và xưng hô phải tuân thủ tuyệt đối các quy định dưới đây.
...
* **Tàn Hài (なれはて - Narehate):** Trạng thái quái vật dị hình cuối cùng sau khi ma nữ hóa hoàn toàn. Những cá thể dễ thuần hóa sẽ bị tẩy não để trở thành **Cai Ngục (看守 - Jailer)** canh giữ nhà tù.
...
## 👥 2. MA TRẬN NHÂN VẬT & ĐẠI TỪ XƯNG HÔ (CHARACTER PRONOUN MATRIX)
...
* **Tính cách:** Lạnh lùng, điềm tĩnh, nghiêm khắc, mang mối thù hận và dằn vặt sâu sắc với Ema vì biến cố trong quá khứ ("đã bỏ mặc bạn mình chết").
* **Đại từ JP:** `私` (Watashi) / `君` (Kimi)
* **Xưng hô Tiếng Việt:**
  * **Tự xưng:** **tôi**
  * **Gọi người khác:** **cậu** / **cô** / **[Tên]** (nói với Ema bằng giọng điệu cay nghiệt, dứt khoát: *"Tôi ghét cậu"*).
...
* **Xưng hô Tiếng Việt:**
  * **Tự xưng:** **tôi**
  * **Gọi người khác:** **bạn** / **các bạn** / **[Tên]**

### 15. Gokuchou (ゴクチョー / Cai Ngục Trưởng) — [ID: Warden]
* **Vai trò:** Quái vật đầu cú mèo, kẻ chủ tọa phiên tòa ma nữ.
...
## 🏛️ 3. TỪ ĐIỂN THUẬT NGỮ CỐT LÕI (MASTER GLOSSARY)
...
| **なれはて** | 残骸 / 终末者 | **Tàn Hài** | Quái vật ma nữ hoàn toàn. |
...
## 🗺️ 4. DANH MỤC ĐỊA DANH BẢN ĐỒ (MAP LOCATIONS)

| Địa danh JP | Địa danh ZH | Tên Tiếng Việt chuẩn |
| :--- | :--- | :--- |
| **監房** | 牢房 | **Phòng Giam** |
| **裁判所** | 审判庭 | **Tòa Án / Phòng Xét Xử** |
...
| **サンルーム** | 日光房 | **Phòng Tắm Nắng** |
| **ノアのアトリエ** | 诺亚的画室 | **Xưởng Vẽ Noah** |
...
## ⚡ 5. QUY TẮC KỸ THUẬT BẮT BUỘC KHI DỊCH CHO NANINOVEL

1. **Bảo Tồn Tuyệt Đối Thẻ Phản Biện (`<link="Objection_...">`):**
   * Nếu câu gốc chứa `<link="Objection_01_01_01_01">血で描かれた</link>` ➔ Bản dịch PHẢI giữ nguyên tag: `<link="Objection_01_01_01_01">vẽ bằng máu</link>`.
   * **Cấm làm mất, sai chính tả tên ID hoặc xóa thẻ đóng `</link>`.**
2. **Quy Tắc Xuống Dòng & Auto-Wrap (CỰC KỲ QUAN TRỌNG):**
   * **ĐỂ GAME TỰ ĐỘNG XUỐNG DÒNG (AUTO-WRAP):** Tiếng Việt dùng chữ cái Latin có khoảng trắng giữa các từ, engine TextMeshPro sẽ tự động ngắt dòng trơn tru và hoàn hảo theo từ ngữ.
   * **TUYỆT ĐỐI KHÔNG TỰ TIỆN CHÈN THẺ `<br>` Ở GIỮA CÂU THOẠI.**
   * **Chỉ sử dụng `<br>` khi:** Cần ngắt một đoạn văn lớn rõ rệt (paragraph break) hoặc chia 2 ý thoại riêng biệt trong cùng 1 hộp thoại.
3. **Loại Bỏ Hoàn Toàn Thẻ Furigana (`<ruby>`):**
   * `<ruby="さくらば">桜羽</ruby>` ➔ Dịch thẳng là `Sakuraba` (không giữ lại thẻ ruby).
4. **Giữ Nguyên Thẻ Hệ Thống:**
   * Giữ nguyên các tag icon: `<sprite name="...">`, `<color=...>`, `<size=...>`.
