...
chcp 65001 >nul
title Cài Đặt Patch Việt Hóa - Mahou Shoujo no Majo Saiban
color 0A
...
def create_patch():
    print("==================================================")
    print("       CREATING VIETNAMESE PATCH PACKAGE          ")
    print("==================================================")
    ...
    print("[+] Created Installer & Documentation scripts.")

    # 4. Create ZIP Archive
    zip_filename = os.path.join(GAME_DIR, "Mahou_Shoujo_VietHoa_Patch_v1.0.zip")
    ...
    print(f"\n==================================================")
    print(f"[SUCCESS] Patch created successfully!")
